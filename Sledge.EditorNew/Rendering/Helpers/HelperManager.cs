...
namespace Sledge.EditorNew.Rendering.Helpers
{
    ...
    public class HelperManager
    {
        ...
        public void Render(IMapViewport viewport)
        {
            var vp2 = viewport as IViewport2D;
            var vp3 = viewport as IViewport3D;
            foreach (var helper in _helpers)
            {
                ...
                // Render 2D
                if (viewport.Is2D && helper.Is2DHelper && vp2 != null && _helperCache.ContainsKey(helper))
                {
                ...
                // Render 3D
                if (viewport.Is3D && helper.Is3DHelper && vp3 != null && _helperCache.ContainsKey(helper))
                {
