...
namespace Sledge.EditorNew.Clipboard
{
    public static class ClipboardManager
    {
        ...
        public static void Push(IEnumerable<MapObject> copiedObjects)
        {
            ...
            Ring.Add(item);
            Gui.Components.Clipboard.SetText(item);
        ...
        {
            if (!Gui.Components.Clipboard.HasText()) return null;

            var str = Gui.Components.Clipboard.GetText();
        ...
        {
            if (!Gui.Components.Clipboard.HasText()) return false;
            var str = Gui.Components.Clipboard.GetText();
