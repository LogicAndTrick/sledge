...
namespace Sledge.Rendering.DataStructures
{
    ...
    public class Plane 
    {
        ...
        public Plane(Vector3 p1, Vector3 p2, Vector3 p3)
        {
            ...
            Normal = Vector3.Cross(ac, ab).Normalized();
        ...
        */
        ...
        public Vector3 GetClosestAxisToNormal()
        {
            ...
            var norm = new Vector3(Math.Abs(Normal.X), Math.Abs(Normal.Y), Math.Abs(Normal.Z));
        ...
        */
        ...
        {
            return Math.Abs(Normal.X - other.Normal.X) < delta
                   && Math.Abs(Normal.Y - other.Normal.Y) < delta
                   && Math.Abs(Normal.Z - other.Normal.Z) < delta
